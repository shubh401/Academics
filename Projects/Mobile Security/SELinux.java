...
public class SELinux {
    ...
    /**
     *Compute the default context for a new object to be created.
     *
     *@param subjectContext Context of the object creator
     *@param objectContext Context of the new object's parent object
     *@param objectClass Security class of the new object
     *@return Security context for the new object
     */
    public static native String computeContextCreate(String subjectContext, String objectContext, String objectClass);
