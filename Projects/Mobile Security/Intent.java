...
public class Intent implements Parcelable, Cloneable {
   ...
   /**
    ...
    /*
     * <p> The private variables to contain the sender's and creator's User ID for a particular
     * Intent is listed below.</p>
     */
    private int senderUID = -1;
    private int creatorUID = -1;

    /*
     * <p>The getter methods for the above defined variables are defined below.</p>
    */
    ...
    /*
     * <p> The setter methods for the above defined variables are defined below.</p>
    */
    public void setSenderUID(int sUid) {
        senderUID = sUid;
    }

    public void setCreatorUID(int cUid) {
        creatorUID = cUid;
    }
    ...
    public Intent() {
        ...
        setSenderUID(Process.myUid());
        setCreatorUID(Process.myUid());
    }
    ...
    public Intent(Intent o) {
        ...
        if(o.getSenderUID() > 0) {
            this.setSenderUID(o.getSenderUID());
        }
        
        this.setCreatorUID(o.getCreatorUID());
    }
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        out.writeInt(getSenderUID());
        out.writeInt(getCreatorUID());
    ...
    public void readFromParcel(Parcel in) {
        ...
        setSenderUID(in.readInt());
        setCreatorUID(in.readInt());
