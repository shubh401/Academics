...
public final class PendingIntent implements Parcelable {
    ...
    public static PendingIntent getActivity(Context context, int requestCode,
        ...
        try {
            if (intent.getSenderUID() != UserHandle.myUserId()) {
                intent.setSenderUID(UserHandle.myUserId());
            }
            if (intent.getCreatorUID() != UserHandle.myUserId()) {
                intent.setCreatorUID(UserHandle.myUserId());
            }
    ...
    public void send(Context context, int code, @Nullable Intent intent,
            ...
            throws CanceledException {
        try {
            intent.setCreatorUID(getCreatorUid());
